...
#End Region
    ...
    Function IsMatch(alphaspaceexpression As System.Text.RegularExpressions.Regex) As Boolean
...
Class myCloseButton : Inherits Control
...
<DefaultEvent("TextChanged")> Class PasswordBox : Inherits Control
...
Class ThemeMessageBox : Inherits Control
